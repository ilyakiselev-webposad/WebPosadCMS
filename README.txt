...
сам джанго располагается в папке /home/s/snowsp/dev-p.ru/public_html/venv/lib/python2.7/site-packages

для начала надо переключиться на текущий virtualenv
заходим в папку с проектом

$ cd /home/s/snowsp/dev-p.ru/public_html
$ source venv/bin/activate

проверяем правильно ли определился путь до pip:
$ which pip
/home/s/snowsp/dev-p.ru/public_html/venv/bin/pip
...
$ pwd
/home/s/snowsp/dev-p.ru/public_html/HelloDjango/HelloDjango/tmp
$ touch restart.txt